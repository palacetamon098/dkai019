...
local Window = Fluent:CreateWindow({
    Title = "Dakii Hub",
    SubTitle = "https://discord.gg/hMG6s2PH7K",
    TabWidth = 160,
    Size = UDim2.fromOffset(560, 350),
    Acrylic = true, 
    Theme = "Amethyst",
    MinimizeKey = Enum.KeyCode.Y -- minimizekey 
})
...
ToggleButton.Text = " Y "
ToggleButton.TextColor3 = Color3.fromRGB(12, 223, 242)
ToggleButton.TextSize = 14.000
ToggleButton.Draggable = true
ToggleButton.MouseButton1Click:Connect(function()
	game:GetService("UserInputService"):SendKeyEvent("Y", true, game)
end)
...
function GetMaterial(matname)
    ...
    local Status1 = "Ping: "..Ping.." | Sea: "..StatusWorld
    ...
    Tabs.Main:AddButton({
        Title = "Join Discord - Dakii Hub",
        Description = "",
        Callback = function()
            setclipboard("https://dsc.gg/dakii")
        end
    })
...
print("made by Dakii & M1m (Mbm or minh)")
print("Dakii Hub")
print("join my discord server : https://dsc.gg/dakii")
print("pr")
...
InterfaceManager:SetFolder("Dakii Hub")
SaveManager:SetFolder("Main")
